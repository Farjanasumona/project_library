...
$tot=mysqli_num_rows($res);
 ...
 if(isset($_SESSION['username']))
   ...
   {
     $res=mysqli_query($link,"select * from u_reg where username= '$_SESSION[username]'");
            ...
            <div class="left_col scroll-view">
              ...
              <div class="profile clearfix">
                  <div class="profile_pic">
                    <?php
            				echo "<div class='pic'><img class='img-circle profile_img' height=90 width=120 src='images/".$_SESSION['pic']."'></div> ";
            			?>
                  ...
                  <div class="menu_section">
                      ...
                      <ul class="nav side-menu">
                        ...
                        <li><a href="profile.php"><i class="fa fa-desktop"></i>My Profile<span class="fa fa-chevron-down"></span></a>
                          ...
                          <li><a href="my_issued_books.php"><i class="fa fa-desktop"></i>My Issued Books<span class="fa fa-chevron-down"></span></a>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown"
                                   aria-expanded="false">
                                   <?php
                           				echo "<div class='pic'><img src='images/".$_SESSION['pic']."'></div> ";
                           			?>
                            ...
                            <li role="presentation" class="dropdown">
                                <a href="javascript:;" class="dropdown-toggle info-number" data-toggle="dropdown"
                                   aria-expanded="false">
                                    <i class="fa fa-envelope" onclick="window.location='message_from_librarian.php';" ></i>
