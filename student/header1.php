            ...
            <div class="left_col scroll-view">
              ...
              <div class="profile clearfix">
                  <div class="profile_pic">
                      <img src="5.PNG" alt="..." class="img-circle profile_img">
                  </div>
                  ...
                  <div class="menu_section">
                      ...
                      <ul class="nav side-menu">
                        <li><a href="index.php"><i class="fa fa-home"></i>HOME<span class="fa fa-chevron-down"></span></a>
                          ...
                          <li><a href="reg.php"><i class="fa fa-edit"></i>sign up<span class="fa fa-chevron-down"></span></a>
                          ...
                          <li><a href="loginal.php"><i class="fa fa-desktop"></i>Issue Books<span class="fa fa-chevron-down"></span></a>
