 ...
 ?>
	<?php
			if(isset($_POST['submit']))
			{
                ...
                $sql ="UPDATE u_reg SET image='$pic',firstname='$firstname',lastname='$lastname',username='$username',password='$password',contact='$contact' WHERE username='".$_SESSION['username']."';";
	 ...
	 <body style="background-color: #2d6548">
	   ...
	   <h2 class="text-center" style="color: #fff">Basic Information</h2>
	    ...
	    if(isset($_SESSION['username']))
	     	...
	     	{
	     	$sql = "SELECT * FROM u_reg WHERE username='$_SESSION[username]'";
