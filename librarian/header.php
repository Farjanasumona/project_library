...
include"connection.php";
 ...
 if(isset($_SESSION['librarian']))
   ...
   {
     $res=mysqli_query($link,"select * from l_reg where username= '$_SESSION[librarian]'");
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                          ...
                          <li><a href="profile.php"><i class="fa fa-desktop"></i> My profile<span
                            ...
                            <li><a href="send_notification_student.php"><i class="fa fa-envelope-o"></i> Send Messages To Student<span
                                    class="fa fa-chevron-down"></span></a>
